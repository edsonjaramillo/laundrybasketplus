  ...
  <div className='legal responsive-width'>
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Account</strong> means a unique account created for You
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Cookies</strong> are small files that are placed on Your
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Personal Data</strong> is any information that relates
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Service Provider</strong> means any natural or legal
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <strong className='legal__strong'>Cookies or Browser Cookies.</strong> A cookie is a small
        ...
        able to use some parts of our Service. Unless you have adjusted Your browser setting so that
        it will refuse Cookies, our Service may use Cookies.
      </li>
      <li className='legal__bullet'>
        <strong className='legal__strong'>Flash Cookies.</strong> Certain features of our Service
        may use local stored objects (or Flash Cookies) to collect and store information about Your
      ...
      <li className='legal__bullet'>
        <strong className='legal__strong'>Web Beacons.</strong> Certain sections of our Service and
        our emails may contain small electronic files known as web beacons (also referred to as
        clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to
        count users who have visited those pages or opened an email and for other related website
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>To provide and maintain our Service</strong>, including
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>To provide You</strong> with news, special offers and
          general information about other goods, services and events which we offer that are similar
          to those that you have already purchased or enquired about unless You have opted not to
          receive such information.
        </p>
      </li>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>To manage Your requests:</strong> To attend and manage
          Your requests to Us.
        </p>
      </li>
      <li className='legal__bullet'>
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>For other purposes</strong>: We may use Your information
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        ...
        personal information with Service Providers to monitor and analyze the use of our Service,
        to contact You.
      </li>
      <li className='legal__bullet'>
        <strong className='legal__strong'>For business transfers:</strong> We may share or transfer
      ...
      <li className='legal__bullet'>
        <strong className='legal__strong'>With Affiliates:</strong> We may share Your information
      ...
      <li className='legal__bullet'>
        ...
        information or otherwise interact in the public areas with other users, such information may
        be viewed by all users and may be publicly distributed outside.
      </li>
      <li className='legal__bullet'>
        <strong className='legal__strong'>With Your consent</strong>: We may disclose Your personal
    ...
    <ul className='legal__list'>
      ...
      <li className='legal__bullet'>Protect and defend the rights or property of the Company</li>
      <li className='legal__bullet'>
