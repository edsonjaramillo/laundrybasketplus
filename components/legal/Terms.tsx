  ...
  <div className='legal responsive-width'>
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Affiliate</strong> means an entity that controls, is
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Device</strong> means any device that can access the
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>You</strong> means the individual accessing or using the
    ...
    <p>
      ...
      apply. In these states, each party&apos; liability will be limited to the greatest extent
      permitted by law.
    </p>
    <h2 className='legal__subheader'>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
    <p>
    ...
    <p>
      ...
      obligation under these Terms shall not effect a party&apos; ability to exercise such right or
